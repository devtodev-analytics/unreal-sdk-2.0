...
EDTDRemoteConfigSource MacConverter::Convert(DTDRemoteConfigSource value)
{
	switch (value)
	{
...
NSDictionary<NSString *, id>* MacConverter::ConvertToDefaults(const FDTDRemoteConfigDefaults& defaults)
{
