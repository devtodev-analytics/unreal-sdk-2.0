...
private:
	...
	const FDTDAnalyticsInitializationCompleteDelegate* completetionCallback = nullptr;
...
public:
	...
	void SetInitializationCompleteCallback(const FDTDAnalyticsInitializationCompleteDelegate* callback);
