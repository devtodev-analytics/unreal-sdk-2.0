...
public:
    ...
    static EDTDRemoteConfigSource Convert(DTDRemoteConfigSource value);
    static NSDictionary<NSString *, id>* ConvertToDefaults(const FDTDRemoteConfigDefaults& defaults);
};
